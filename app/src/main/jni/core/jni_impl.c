...
static int loadBlacklistsInfo(pcapdroid_t *pd) {
    ...
    jobject type_ip = jniEnumVal(env, "com/lag/maldefender/model/BlacklistDescriptor$Type", "IP_BLACKLIST");
...
Java_com_lag_maldefender_CaptureService_runPacketLoop(JNIEnv *env, jclass type, jint tunfd,
    ...
    cls.conn = jniFindClass(env, "com/lag/maldefender/model/ConnectionDescriptor");
    cls.conn_update = jniFindClass(env, "com/lag/maldefender/model/ConnectionUpdate");
    cls.stats = jniFindClass(env, "com/lag/maldefender/model/VPNStats");
    cls.blacklist_status = jniFindClass(env, "com/lag/maldefender/model/Blacklists$NativeBlacklistStatus");
    cls.blacklist_descriptor = jniFindClass(env, "com/lag/maldefender/model/BlacklistDescriptor");
    cls.matchlist_descriptor = jniFindClass(env, "com/lag/maldefender/model/MatchList$ListDescriptor");
    ...
    mids.updateConnections = jniGetMethodID(env, vpn_class, "updateConnections", "([Lcom/lag/maldefender/model/ConnectionDescriptor;[Lcom/lag/maldefender/model/ConnectionUpdate;)V");
    mids.sendStatsDump = jniGetMethodID(env, vpn_class, "sendStatsDump", "(Lcom/lag/maldefender/model/VPNStats;)V");
    ...
    mids.notifyBlacklistsLoaded = jniGetMethodID(env, vpn_class, "notifyBlacklistsLoaded", "([Lcom/lag/maldefender/model/Blacklists$NativeBlacklistStatus;)V");
    mids.getBlacklistsInfo = jniGetMethodID(env, vpn_class, "getBlacklistsInfo", "()[Lcom/lag/maldefender/model/BlacklistDescriptor;");
    mids.connInit = jniGetMethodID(env, cls.conn, "<init>", "(IIILjava/lang/String;Ljava/lang/String;IIIIIJ)V");
    mids.connProcessUpdate = jniGetMethodID(env, cls.conn, "processUpdate", "(Lcom/lag/maldefender/model/ConnectionUpdate;)V");
    ...
    fields.bldescr_type = jniFieldID(env, cls.blacklist_descriptor, "type", "Lcom/lag/maldefender/model/BlacklistDescriptor$Type;");
...
JNIEXPORT void JNICALL
Java_com_lag_maldefender_CaptureService_stopPacketLoop(JNIEnv *env, jclass type) {
...
JNIEXPORT void JNICALL
Java_com_lag_maldefender_CaptureService_askStatsDump(JNIEnv *env, jclass clazz) {
    if(running)
...
Java_com_lag_maldefender_CaptureService_getFdSetSize(JNIEnv *env, jclass clazz) {
    return FD_SETSIZE;
}
...
JNIEXPORT void JNICALL
Java_com_lag_maldefender_CaptureService_setDnsServer(JNIEnv *env, jclass clazz,
                                                               jstring server) {
...
Java_com_lag_maldefender_CaptureService_getPcapHeader(JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_com_lag_maldefender_CaptureService_reloadBlacklists(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jint JNICALL
Java_com_lag_maldefender_CaptureService_getNumCheckedConnections(JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_com_lag_maldefender_CaptureService_setPrivateDnsBlocked(JNIEnv *env, jclass clazz, jboolean to_block) {
...
Java_com_lag_maldefender_CaptureService_reloadBlocklist(JNIEnv *env, jclass clazz,
        jobject ld) {
    pcapdroid_t *pd = global_pd;
    if(!pd) {
...
JNIEXPORT jboolean JNICALL
Java_com_lag_maldefender_CaptureService_reloadMalwareWhitelist(JNIEnv *env, jclass clazz,
                                                                         jobject whitelist) {
    pcapdroid_t *pd = global_pd;
    if(!pd) {
        log_e("NULL pd instance");
