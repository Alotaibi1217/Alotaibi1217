...
import com.lag.maldefender.activities.CaptureCtrl;
import com.lag.maldefender.activities.ConnectionsActivity;
import com.lag.maldefender.activities.MainActivity;
import com.lag.maldefender.fragments.ConnectionsFragment;
import com.lag.maldefender.interfaces.SslkeylogDumpListener;
import com.lag.maldefender.model.AppDescriptor;
import com.lag.maldefender.model.BlacklistDescriptor;
import com.lag.maldefender.model.Blacklists;
import com.lag.maldefender.model.CaptureSettings;
import com.lag.maldefender.model.ConnectionDescriptor;
import com.lag.maldefender.model.ConnectionUpdate;
import com.lag.maldefender.model.FilterDescriptor;
...
import com.lag.maldefender.pcap_dump.FileDumper;
import com.lag.maldefender.pcap_dump.HTTPServer;
import com.lag.maldefender.interfaces.PcapDumper;
import com.lag.maldefender.pcap_dump.UDPDumper;
...
public class CaptureService extends VpnService implements Runnable {
    ...
    public int onStartCommand(@Nullable Intent intent, int flags, int startId) {
        ...
        //  adb shell ps | grep remote_capture | awk '{print $2}' | xargs adb shell run-as com.lag.maldefender.debug kill
